...
export const metadata: Metadata = {
    ...
    description: "Learn about the admission process, requirements, and applying to Kashmir Cambridge.",
...
export default function AdmissionPage() {
    return (
        <>
            <Header />
            <Breadcrumb title="Apply to Kashmir Cambridge Group of Schools" current="Apply Admission" />
