  ...
  return (
    <>
      <div className="admission-content-top">
        <h3 className="rts-section-title">New Student Admissions</h3>

        <div className="admission-big-thumb">
          <img src="/assets/images/admission/admission.png" alt="admission" />
        </div>
        ...
        <div className="requirement-deadline">
          ...
          <div className="requirement-deadline__content">
            <ul>
              ...
              <li className="single-requirement">
        ...
        <div className="application-deadline">
          ...
          <div className="application-deadline__content">
            ...
            <p>
              {" "}
              Kashmir Cambridge reserves the right to evaluate an application
              and render a final decision based on seat availability and
              assessment results.
            </p>
            <p className=" mx-0">
              If you have any questions regarding the application process,
              please reach out to our admission office directly. We encourage
              early applications as seats fill up quickly.
            </p>
          </div>
        </div>
      </div>
